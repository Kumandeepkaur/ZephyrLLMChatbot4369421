...
def respond(
    ...
    system_message = "Welcome to the Motivational Speaker Chatbot! I'm here to help you stay inspired and achieve your goals. Ask me for motivational quotes, success stories, or advice on overcoming challenges. Let's turn your dreams into reality and make today amazing!"
...
demo = gr.ChatInterface(
    ...
    examples = [ 
        ...
        ["Can you share a success story to inspire me?"],
